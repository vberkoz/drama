                        ...
                        <nav>
                            <ul>
                                <?php foreach ($categories as $category): ?>
                                    <li><a href="<?php echo $category['link']; ?>" <?php echo (strpos($_SERVER['REQUEST_URI'], $category['link']))?'class="active1"':null?>><?php echo $category['title']; ?></a></li>
                                <?php endforeach; ?>
                            </ul>
                        </nav>
                    </div>
            ...
            <?php foreach ($categoryPerformances as $performance): ?>
                ...
                <a href='/spectacle/<?php echo $performance['link']; ?>'>
                    <div class='reper-block reper-block-img <?php echo "$thirdFourth1 $secondFourth1"; ?>'>
                        <div class='square' style="opacity: 1; background: url('/assets/images/original/<?php echo $performance['image']; ?>')center/cover;"></div>
                    </div>
