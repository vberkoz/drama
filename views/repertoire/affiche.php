...
<section class="theatre">
	<div class="container">
        <!-- <div class="title"><h1>Репертуар</h1></div> -->
        <div class="menu-line">
            <!-- <div class="container"> -->
                <div class="row">
                    <div class="col-md-12">
                            ...
                            <ul>
                                <li>
                                    <a href="/affiche/<?php echo strtolower($currentMonth); ?>"
                                        <?php echo (strpos($_SERVER['REQUEST_URI'], strtolower($currentMonth)))?'class="active1"':null?>>
                                        <?php echo $uaMonthNames[$currentMonthNum - 1]; ?>
                                    </a>
                                </li>
                                <li>
                                    <a href="/affiche/<?php echo strtolower($nextMonth); ?>"
                                        <?php echo (strpos($_SERVER['REQUEST_URI'], strtolower($nextMonth)))?'class="active1"':null?>>
            ...
            <?php foreach ($spectacles as $spectacle): ?>
                ...
                <a href='/spectacle/<?php echo $spectacle['link']; ?>'>
                    <div class='reper-block reper-block-img <?php echo "$thirdFourth1 $secondFourth1"; ?>'>
                        <div class='square' style="opacity: 1; background: url('/assets/images/original/<?php echo $spectacle['image']; ?>')center/cover;">
